...
module.exports = {
  ...
  ENVIRONMENT_TYPES: productionPublisher.ENVIRONMENT_TYPES,
  PROTECTED_DOMAINS: productionPublisher.PROTECTED_DOMAINS,
  registerProtectedDomain: productionPublisher.registerProtectedDomain,
  clearProtectedDomains: productionPublisher.clearProtectedDomains,
  getProtectedDomains: productionPublisher.getProtectedDomains,
  ...
  REAL_CASTLINK_DOMAIN_STATUS: productionPublisher.REAL_CASTLINK_DOMAIN_STATUS,
  getRealCastLinkDomainStatus: productionPublisher.getRealCastLinkDomainStatus,
  ERR_PUBLICATION_CONTEXT_AMBIGUOUS: productionPublisher.ERR_PUBLICATION_CONTEXT_AMBIGUOUS,
  ERR_PROTECTED_ENVIRONMENT_UNTOUCHABLE: productionPublisher.ERR_PROTECTED_ENVIRONMENT_UNTOUCHABLE,
  ERR_PROTECTED_DOMAIN_FORBIDDEN: productionPublisher.ERR_PROTECTED_DOMAIN_FORBIDDEN,
